...
def main(seed=2018, epoches=80):
    ...
    #         print("hiiiiiii ",patch[0].shape)
    #         plt.figure(0)
    #         plt.imshow(inputs[0])
    #         plt.figure(1)
    #         plt.imshow(target[0])
    #         plt.figure(2)
    #         plt.imshow(torch.reshape(patch[0], (256, 256, 3)))
    #         plt.show()
...
###############
    ...
    dir_name = 'log/' + str(args.dataset_name) + '_' + str(args.model_name) + '_' + str(args.loss_name) + '_' + data_val1.test[1] + '_' + str(args.lr)
    # print(dir_name)
